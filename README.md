...
`python3 scripts/attach_resume_manifest.py --release-manifest release-manifest-v0.3.31.json --resume-manifest resume-manifest.json --output release-manifest-with-resume.json`.
...
[`release-manifest-v0.3.31.json`](release-manifest-v0.3.31.json). The current Lazy SMP USI smoke
transcript is [`scripts/fixtures/usi_smoke_v0.3.31.txt`](scripts/fixtures/usi_smoke_v0.3.31.txt).
...
python3 scripts/record_mcts_manifest.py \
  --release-manifest release-manifest-v0.3.31.json \
