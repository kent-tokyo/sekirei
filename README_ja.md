...
**Janos** はハンガリー語の名前 **János** に由来しています。

計算理論とゲーム理論の礎を築いたジョン・フォン・ノイマン（Neumann János）、
そして伝統を受け継ぎながら独自の音楽言語を作り上げたバルトーク・ベーラ（Bartók János）
への敬意を込めています。

Janosは既存の将棋エンジンのアイデアを踏まえつつ、Rustを用いてより安全で
保守しやすい実装を探求するプロジェクトです。
