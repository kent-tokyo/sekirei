# Archived detailed changelog

This snapshot preserves the detailed release history before the public
changelog was condensed on 2026-09-18. It is historical evidence; use the
root `CHANGELOG.md` for the current release summary.
